...
twitch_miner = TwitchChannelPointsMiner(
    username="adellevi",
    password="tsITL060301..",           # If no password will be provided, the script will ask interactively
    ...
    logger_settings=LoggerSettings(
        save=False,                              # If you want to save logs in a file (not suggested)
    ...
    streamer_settings=StreamerSettings(
        make_predictions=False,                  # If you want to Bet / Make hulahula
